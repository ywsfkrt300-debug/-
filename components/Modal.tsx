...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, isLoading = false }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-white/80 backdrop-blur-md rounded-lg shadow-xl w-full max-w-md m-4"
      ...
      >
        ...
        <div className="p-6 relative">
          {children}
          {isLoading && (
            <div className="absolute inset-0 bg-white/70 flex items-center justify-center rounded-b-lg -m-6 mt-0">
